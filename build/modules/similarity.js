...
exports.default = processSimilarities;
function processSimilarities(data) {
...
var filterSimilars = function filterSimilars(data, simStore) {
  var keyMappings = [];
...
var anyCommonId = function anyCommonId(ids1, ids2) {
  for (var i in ids1) {
    for (var j in ids2) {
      if (ids1[i] == ids2[j]) {
        return true;
